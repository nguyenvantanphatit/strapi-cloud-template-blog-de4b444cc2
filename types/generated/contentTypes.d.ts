...
export interface ApiUploadTestUploadTest extends Struct.CollectionTypeSchema {
  collectionName: 'upload_tests';
  info: {
    singularName: 'upload-test';
    pluralName: 'upload-tests';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::upload-test.upload-test': ApiUploadTestUploadTest;
